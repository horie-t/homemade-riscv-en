...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { io_clock }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports {io_clock}];


##Switches

set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { io_data }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { io_q }]; #IO_L18P_T2_A24_15 Sch=led[0]

set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets io_q_OBUF_inst_i_3_n_0]
set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets srFF/dFF/dLatch1_io_q]
...
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { io_resetNegate }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
